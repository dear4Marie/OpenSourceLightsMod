...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    const PROGMEM uint16_t Schemes[NumSchemes][NumLights][NumStates] =
    {
        ...
        // ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            {  OFF,       ON,        ON,        ON,         ON,        NA,         NA,         NA,       NA,        NA,       NA,            NA,           NA,            NA       },  // Light 2    -- Headlight Two - ON when Channel 3 is in the middle-to-far position, fadeoff otherwise
            {  OFF,       DIM,       DIM,       DIM,        DIM,       NA,         NA,         ON,       NA,        ON,       NA,            NA,           NA,            ON       },  // Light 3    -- Brake Light - ON when Braking, otherwise DIM if Channel 3 is in the middle-to-far positions
