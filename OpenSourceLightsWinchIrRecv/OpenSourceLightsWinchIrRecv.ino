...
// ====================================================================================================================================================>
    ...
    // IR RECIEVE
        ...
        char       irRecvData[8];
        IRrecv irrecv(IRRecvPin, GreenLED);
...
//        IRrecvPCI myReceiver(2);//pin number for the receiver
    ...
    // ------------------------------------------------------------------------------------------------------------------------------------------------>
        ...
        int LightPin[NumLights] = {9,11,10,6,5,8,15,16};        // These are the Arduino pins to the 8 lights in order from left to right looking down on the top surface of the board. 
                                                                // Note that the six Arduino analog pins can be referred to by numbers 14-19
        int Dimmable[NumLights] = {1,0,1,1,1,0,0,0};            // This indicates which of these pins are capable of ouputting PWM, in order. PWM-capable pins on the Arduino are 3, 5, 6, 9, 10, 11
...
//        }
        ...
        if (DEBUG == true)
        {
//            Serial.print(F("IR Receive Data : "));
...
//            Serial.println(ThrottleCommand);
    ...
    // ------------------------------------------------------------------------------------------------------------------------------------------------>    
        ...
        {   // The last backfire is over, and we have started decelerating again. Enable the backfire effect. 
            ...
            Serial.println(BackfireTimerID);
        } 
        ...
        if (Accelerating && !Overtaking)
          {  //  The last overtaking is over, and we have started accelerating again. Enable the Overtaking timer again.
            ...
            Serial.println(OvertakeTimerID);
        } 
