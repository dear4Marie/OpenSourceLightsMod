...
// STATE SETTINGS
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    #define LongStopTime_mS          60000          // The Stop Delay state only occurs when the vehicle has been stopped for some length of time, which is set here. 
                                                    // Recall that 1000 mS = 1 second (default value is 30 seconds)


// LIGHT SETTINGS - DIM LEVEL
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    #define DimLevel                    40          // Number from 0-255, with 0 being off, 255 being full on. Often numbers much greater than half (128) are hard to distinguish from full on. 
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    #define BlinkTurnOnlyAtStop       false         // If you only want your turn signal blinkers to come on when the car is Stopped, set this to true. 
