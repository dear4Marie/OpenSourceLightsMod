...
unsigned int OSL_SimpleTimer::setInterval(long d, timer_callback f) {
  	//Serial.print(F("setInterval ")); Serial.println(d);
    return setTimer(d, f, RUN_FOREVER);
}


unsigned int OSL_SimpleTimer::setTimeout(long d, timer_callback f) {
    //Serial.print(F("setTimeout ")); Serial.println(d);
...
{
    //Serial.print(F("restartTimer ")); Serial.println(ID);
    int timerNum;
...
{
    //Serial.print(F("isEnabled ")); Serial.println(ID);
    int timerNum;
...
{
    //Serial.print(F("enable ")); Serial.println(ID);
    int timerNum;
...
{
    //Serial.print(F("disable ")); Serial.println(ID);
    int timerNum;
...
{
    //Serial.print(F("toggle ")); Serial.println(ID);
    int timerNum;
